...
//==============================================================
		...
		names.forEach(Person::new);//called constarctor  which is One parameter constarctor in Person class and assign
...
//========================peek()===========================================
		...
		System.out.println("peek_______________");
...
//===========================================================
        ...
        System.out.println("Sequential findAny: " + result1);
        ...
        String result2 = names.parallelStream()
                              .findAny()
                              .orElse("Not Found");
        System.out.println("Parallel findAny: " + result2);
